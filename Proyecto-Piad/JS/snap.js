 $(Document).ready(function(){
  ...
  const  $VPrevisualizacion = document.getElementById('video');
  ...
  // transmitir cuando tengamos acceso
  function handleSuccess(stream) {
    window.stream = stream;
     $VPrevisualizacion.srcObject = stream;

    Normal();
    espejo();

    $(".filters").addClass("watch");
    $(".controller").addClass("watch");
  }
